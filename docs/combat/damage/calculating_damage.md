...
1. For each level of proficiency you have with the weapon, you deal an additional die of damage. The die is the same as the type of die used in the weapon’s base damage, which is based on the weapon’s complexity and handedness.
